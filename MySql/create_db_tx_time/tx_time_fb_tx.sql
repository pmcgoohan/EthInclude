...
--
-- Table structure for table `fb_tx`
--

DROP TABLE IF EXISTS `fb_tx`;
...
CREATE TABLE `fb_tx` (
  ...
  `eoa_address` varchar(42) DEFAULT NULL,
  `to_address` varchar(42) DEFAULT NULL,
  `gas_used` bigint unsigned DEFAULT NULL,
  `gas_price` bigint unsigned DEFAULT NULL,
  `coinbase_transfer` varchar(42) DEFAULT NULL,
  `total_miner_reward` bigint unsigned DEFAULT NULL,
  PRIMARY KEY (`hash`)
