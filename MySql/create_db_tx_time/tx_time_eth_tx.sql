...
CREATE TABLE `eth_tx` (
  ...
  `inclusion_time` datetime(3) DEFAULT NULL,
  `is_warm` bit(1) DEFAULT NULL,
  `is_dark` bit(1) DEFAULT NULL,
  `delay_ms` int DEFAULT NULL,
  `arrival_index` bigint unsigned DEFAULT NULL,
  `inclusion_index` bigint unsigned DEFAULT NULL,
  `arrival_block` bigint DEFAULT NULL,
  PRIMARY KEY (`hash`)
